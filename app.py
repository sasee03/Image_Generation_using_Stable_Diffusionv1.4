...
add_bg_from_local('download.jpeg')  # Replace with the path to your image
...
if st.sidebar.button("Generate Image"):
    ...
    st.sidebar.write("""
        ...
        2. Choose how many images you want to generate using the slider.
        3. Click the 'Generate Images' button.
        4. The images will be displayed along with the time taken for generation.
    """)

    st.sidebar.subheader("Tips")
    st.sidebar.write("""
        - The more descriptive your prompt, the better the generated image will be.
        - Example prompts: 
          * 'A futuristic cityscape at sunset'
          * 'A cat sitting on a beach with sunglasses'""")
    st.sidebar.subheader("Model Details")
    st.sidebar.write("""
        This app uses the *Stable Diffusion v1-4* model to generate images based on text prompts.
        The model is a latent diffusion model trained on a wide variety of images.
    """)